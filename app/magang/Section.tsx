    ...
    return (
        <div className='flex justify-center min-h-[40vh] p-4'>
            <div className="lg:w-[70%] shadow-sm rounded-sm p-4">
                <div className="font-bold uppercase text-xl">Lowongan Magang <br /> RSUD dr Abdul Aziz</div>
                ...
                <div className="rounded-sm shadow-sm p-3 ">
                    <div className="pb-1 pr-5 w-fit border-b-4 border-primary text-primary mb-3">Daftar Magang</div>
