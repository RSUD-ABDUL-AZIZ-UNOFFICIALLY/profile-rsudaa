...
import FormApplyLoker from './FormMagangLoker';
import FormMagangLoker from './FormMagangLoker';
                    ...
                    {data ?
                        <>
                            <div className="">
                                ...
                                {apply == false ? <button onClick={() => setApply(true)} className="btn btn-primary mt-4 rounded-sm">Apply</button> : <FormMagangLoker item={data} />}
