...
const Section = () => {
    ...
    const [deleteSelect, setDeleteSelect] = useState<activityResponse | null>(null)
                    ...
                    <div className="bg-white p-4 rounded-lg">
                        <div className="font-bold uppercase text-red-500">
                            <div className="">
                                ...
                                <div className="">
                                    <div className="text-xs p-2 bg-red-500 text-white w-fit rounded">judul kegiatan : {deleteSelect.title}</div>
                                </div>
                            </div>
                            <div className="flex gap-2 mt-5 justify-center">
                                <button onClick={() => handleDelete(`${deleteSelect.activityID}`)} className="btn btn-success text-white w-20">Ya</button>
                                ...
                                <React.Fragment key={index}>
                                    <div className="p-4 rounded-lg shadow-slate-100 shadow">
                                        ...
                                        <div className="flex justify-end gap-3 mt-4">
                                            <button onClick={() => navigation.push(`/admin-rsaa/kegiatan/edit/${item.activityID}`)} className='btn btn-warning'>
