...
const FormMaklumatPelayanan = () => {
    ...
    const handleUpdate = async () => {
        try {
            const response = await axios.post(`${API_URL}/api/profile/update/maklumat-pelayanan`, {
                desc: data
            }, {
                headers: {
    ...
    return (
        <div className='grid gap-2 w-full'>
            <div className="">Keterangan Maklumat Pelayanan</div>
...
export default FormMaklumatPelayanan