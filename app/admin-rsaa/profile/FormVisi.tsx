...
const FormVisi = () => {
    ...
    const handleUpdate = async () => {
        try {
            const response = await axios.post(`${API_URL}/api/profile/update/visi`, {
                desc: data
            }, {
                headers: {
    ...
    return (
        <div className='grid gap-2'>
            ...
            <button onClick={handleUpdate} className='btn btn-primary'>Update Visi</button>
        </div>
    )
}

export default FormVisi