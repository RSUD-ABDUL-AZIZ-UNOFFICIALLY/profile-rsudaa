...
const Section: React.FC<props> = ({ id }) => {
    ...
    return (
        <div className='p-5 flex justify-center'>
            {success && <AlertSuccess title='Update magang' />}
            <div className="rounded-xl shadow-md w-full lg:w-[70%]">
                <div className="card-body grid lg:grid-cols-4">
                    ...
                    <label className="form-control w-full lg:col-span-4">
                        ...
                        <textarea {...setValue} {...register("desc", { required: true })} rows={4} placeholder="masukan deskripsi magang" className="textarea textarea-bordered w-full" ></textarea>
                        {errors.desc &&
                            <div className="flex justify-end">
