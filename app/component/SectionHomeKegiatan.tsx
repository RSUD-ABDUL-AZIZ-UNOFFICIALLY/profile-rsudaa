...
const SectionHomeKegiatan = () => {
    ...
    return (
        <div className='grid lg:md:grid-cols-10 mt-4 '>
            <div className="col-span-5 overflow-hidden bg-ren">
                <Image
                    src={item}
