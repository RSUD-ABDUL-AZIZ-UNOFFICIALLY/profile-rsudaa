...
const Kegiatan = () => {
    ...
    const getData = async () => {
        try {
            const response = await axios.get(`http://localhost:4444/api/activity?data=${numberData}`)
    ...
    const [ActivitySelect, setActivitySelect] = useState<ActivityResponse | null>()

    const handleActivitySelect = (item: ActivityResponse) => {
                            ...
                            <>
                                <div className="flex justify-center">
                                    <div className="grid gap-3 lg:w-[70%] ">
                                        <div className="text-3xl text-white">{ActivitySelect.title}</div>
                                        <div className="text-gray-300 text-sm">{moment(ActivitySelect.createdAt).format('DD MMMM YYYY')}</div>
                                        ...
                                        <div className="text-gray-200">{ActivitySelect.desc}</div>
                                    </div>
                                </div>
                            </>
                            :
                                    ...
                                    <React.Fragment key={index}>
                                        <div className="card bg-[#000000a0] rounded-md overflow-hidden">
                                            <div className="grid grid-cols-2">
                                                <button onClick={() => handleActivitySelect(item)} className=" overflow-hidden rounded-tr-3xl h-full">
                                                ...
                                                <div className="p-2">
                                                    ...
                                                    <button onClick={() => handleActivitySelect(item)} className='hover:scale-105 active:scale-95 duration-200 text-warning'>
